...
<head>
    ...
    <style>
        ...
        .hero-section::before {
            ...
            right: 0;
            bottom: 0;
            background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="music-notes" patternUnits="userSpaceOnUse" width="100" height="100"><circle cx="20" cy="20" r="2" fill="rgba(255,255,255,0.1)"/><circle cx="80" cy="60" r="1.5" fill="rgba(255,255,255,0.08)"/><circle cx="60" cy="30" r="1" fill="rgba(255,255,255,0.06)"/><circle cx="40" cy="70" r="2.5" fill="rgba(255,255,255,0.05)"/></pattern></defs><rect width="100" height="100" fill="url(%23music-notes)"/></svg>') repeat;
            opacity: 0.3;
        }
...
<body>
    <!-- Floating Navigation -->
    <div class="floating-nav d-none d-md-block">
        <a href="{{ route('guest.enroll') }}" class="btn btn-primary btn-sm">
            <i class="fas fa-music me-1"></i> Enroll Now
        </a>
                ...
                <div class="col-lg-6">
                    <div class="hero-content">
                        <h1 class="hero-title">
                            Discover Your
                            <span
                                style="background: linear-gradient(45deg, #ff6b6b, #feca57); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Musical</span>
                            Journey
                        </h1>
                        <p class="hero-subtitle">
                            Learn from passionate instructors, master your favorite instrument,
                            and join a community of music lovers. Your musical adventure starts here.
                        </p>
                        <div class="hero-actions">
                            <a href="{{ route('guest.enroll') }}" class="btn cta-button cta-primary">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <p class="feature-description">
                            Learn from professionally trained musicians with years of teaching experience and
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <h4 class="feature-title">Flexible Scheduling</h4>
                        <p class="feature-description">
                            Choose lesson times that work with your schedule. We offer morning, afternoon, and evening
                            slots.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <h4 class="feature-title">All Skill Levels</h4>
                        <p class="feature-description">
                            Whether you're a complete beginner or advanced player, we have courses tailored to your
                            skill level.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <p class="feature-description">
                            Practice in our state-of-the-art studios with professional equipment and excellent
                            acoustics.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <h4 class="feature-title">Performance Opportunities</h4>
                        <p class="feature-description">
                            Showcase your progress in regular recitals and community performances to build confidence.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="feature-card">
                        ...
                        <p class="feature-description">
                            Quality music education at competitive prices with flexible payment plans available.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- Instruments Section -->
    <section class="instruments-section bg-light">
        <div class="container">
            <div class="row text-center mb-5">
                <div class="col-lg-8 mx-auto">
                    <h2 class="display-5 fw-bold mb-3">Choose Your Instrument</h2>
                    <p class="lead text-muted">Explore our wide range of instruments and find the perfect match for your
                        musical aspirations.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="instrument-card">
                        ...
                        <div class="instrument-content">
                            <h5 class="instrument-title">Guitar</h5>
                            <p class="instrument-description">Acoustic and electric guitar lessons for all levels.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="instrument-card">
                        ...
                        <div class="instrument-content">
                            <h5 class="instrument-title">Piano</h5>
                            <p class="instrument-description">Classical and contemporary piano instruction.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="instrument-card">
                        ...
                        <div class="instrument-content">
                            <h5 class="instrument-title">Drums</h5>
                            <p class="instrument-description">Rhythm and percussion for all musical styles.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="instrument-card">
                        ...
                        <div class="instrument-content">
                            <h5 class="instrument-title">Voice</h5>
                            <p class="instrument-description">Vocal training and singing technique development.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="text-center mt-4">
                <a href="{{ route('instruments.index') }}" class="btn btn-primary btn-lg">
                    <i class="fas fa-eye me-2"></i>
                    View All Courses
                </a>
            </div>
    ...
    <section class="hero-section" style="min-height: 60vh;">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <h2 class="display-4 fw-bold mb-4">Ready to Start Your Musical Journey?</h2>
                    <p class="lead mb-5">Join hundreds of students who have discovered their passion for music with us.
                        Enroll today and take the first step towards mastering your favorite instrument.</p>
                    <div class="hero-actions">
                        <a href="{{ route('guest.enroll') }}" class="btn cta-button cta-primary btn-lg">
                            <i class="fas fa-rocket me-2"></i>
                            Enroll Now
                        </a>
                        <a href="tel:+1555123456" class="btn cta-button cta-secondary btn-lg">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ route('instruments.index') }}"
                                class="text-light text-decoration-none">Courses</a></li>
                        <li><a href="{{ route('guest.enroll') }}" class="text-light text-decoration-none">Enroll</a>
                        </li>
                        <li><a href="{{ route('login') }}" class="text-light text-decoration-none">Student Portal</a>
                        </li>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <p class="mb-2"><i class="fas fa-envelope me-2"></i> info@musicschool.com</p>
                    <p class="mb-2"><i class="fas fa-map-marker-alt me-2"></i> 123 Music Lane<br>Harmony City, HC 12345
                    </p>
                </div>
    ...
    <script>
        ...
        document.querySelectorAll('.feature-card, .instrument-card, .stat-item').forEach(el => {
            el.style.opacity = '0';
